...
set _OUTPUTS_PATH synthesis/outputs_dpu
set _REPORTS_PATH synthesis/reports_dpu
set _LOG_PATH synthesis/logs_dpu
...
create_constraint_mode -name nominal -sdc_files "dpu.sdc"
