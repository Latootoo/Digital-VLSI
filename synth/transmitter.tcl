...
set DESIGN transmitter
set SYN_EFF medium
set MAP_EFF high
set DATE [clock format [clock seconds] -format "%b%d"] 
set _OUTPUTS_PATH Outputs/outputs_${DATE}
set _REPORTS_PATH Outputs/reports_${DATE}
set _LOG_PATH Outputs/logs_${DATE}
...
create_constraint_mode -name nominal -sdc_files "transmitter.sdc"
