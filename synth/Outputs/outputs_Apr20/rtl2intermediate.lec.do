...
usage -auto -elapse
set log file Outputs/logs_Apr20/rtl2intermediate.lec.log -replace
tclmode
...
read library -statetable -liberty -both  \
	...
	/afs/ee.cooper.edu/courses/ece447/gpdk/GPDK045/gsclib045_svt_v4.4/gsclib045/timing/slow_vdd1v2_basicCells.lib
...
elaborate design -golden -root transmitter -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	Outputs/outputs_Apr20/transmitter_intermediate.v
} else {
...
elaborate design -revised -root transmitter
...
write hier_compare dofile Outputs/outputs_Apr20/hier_rtl2intermediate.lec.do \
...
run hier_compare Outputs/outputs_Apr20/hier_rtl2intermediate.lec.do -dynamic_hierarchy
